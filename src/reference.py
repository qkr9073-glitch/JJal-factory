...
"anonymous Korean students"처럼 영문으로 명시. **국가가 불분명한 보편 소재도 기본은
한국인/일본인 느낌**("contemporary Korean/Japanese people, modern styling" — 소재가
명시적으로 서양일 때만 서양인). ⚠️뭉뚱그린 "Asian"은 금지 — 중국풍으로 그려지면
최악이다. 안 쓰면 서양인으로 그려져 어색해진다.
...
소재도 기본은 한국인/일본인 느낌**("contemporary Korean/Japanese people, modern
K-fashion styling")이다 — 서양인은 소재가 명시적으로 서양 인물·서양 무대일 때만.
