...
⚠️촬영 국가를 단정하지 마라 — 화면 증거(한글 간판·차량 번호판·들리는 언어)로만 판정.
한국 커뮤·계정에 올라온 영상이어도 해외 촬영본이 흔하다. 불명이면 훅에 국가 언급 금지.
채널 정체성이 '진짜 한국'이므로 한국 촬영이 확실치 않으면 fit 5.0을 넘기지 마라.

JSON만 출력:
{"fit": 0.0, "topic": "영상 내용 한 줄", "why": "적합/부적합 이유 1문장",
 "origin": "한국 확실|불명|해외 — 판정 근거 짧게",
 "hook_ja": "일본어 후킹 자막 시안 1줄 (fit 7+ 일 때만, 아니면 빈 문자열; 원산지 불명이면 국가 언급 없이)",
