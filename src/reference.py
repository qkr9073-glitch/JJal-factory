...
(인물·사실 중심으로만). 정치 진영 소재도 배제. **성별·연령 등 집단을 싸잡는 프레임도 배제** —
비판은 제도·기업·서비스·개별 사건을 겨눈다. 커뮤니티 유머·밈 게시물을 실제 사건·발언처럼
단정하지 마라 — 그런 소재는 '음지' 결로, "온라인에서 화제인 밈"으로만 다룬다.
...
단 비판 결이어도 성별·연령 등 집단 겨냥 프레임은 금지 — 제도·기업·개별 사건만 겨눈다.
